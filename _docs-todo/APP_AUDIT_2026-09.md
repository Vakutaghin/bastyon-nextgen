...
Коммиты `1de0abe`…`f360cb5` (не запушены). Дальше — волна 4 (лента/комментарии/уведомления/кошелёк; V6/V7 ждут Р2).
...
|---|---|---|
| vitest | 2128 passed / 1 skipped (177 файлов; часть тестов покрывает мёртвые модули — X11) → **2425/2425 (228 файлов) на 2026-09-15, после волны 3** | `node_modules/.bin/vitest run` |
