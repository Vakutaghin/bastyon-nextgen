...
Дальше — волна 5 (мессенджер; S43 закрывается тем же решением Р3).
...
|---|---|---|
| vitest | 2128 passed / 1 skipped (177 файлов) → **2480/2480 (238 файлов) на 2026-09-23, после волны 4** | `node_modules/.bin/vitest run` |
