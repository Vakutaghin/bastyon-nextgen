...
## API для интеграции в bastyon-nextgen
...
При реализации в bastyon-nextgen необходимо обеспечить совместимость с существующей системой и правильную обработку всех форматов ключей.
