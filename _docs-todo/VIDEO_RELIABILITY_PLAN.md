...
Phase 1–5 аудита видео-пайплайна **реализованы**: стабилизация плеера/сети, H.264/MP4,
single-copy IPC (commits `2773e5b`, `73c0923`, `30170cb`), браузерный транскодинг на
ffmpeg.wasm (single-thread) и SW-кэш HLS-сегментов. Ниже — только **несделанное**: задачи,
заблокированные инфраструктурой / устройствами / ручной проверкой, и отложенные UX-переписи.
