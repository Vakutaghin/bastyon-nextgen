...
const secp256k1CurveN = new BN("fffffffffffffffffffffffffffffffebaaedce6af48a03bbfd25e8cd0364141", 16);
const m = 12;
...
export class PcryptoService {
  ...
  public async decryptSIVRaw(keyData: Uint8Array, encrypted: Uint8Array, ad: Uint8Array | Uint8Array[]): Promise<Uint8Array> {
    // @ts-ignore
  ...
  public async encryptSIVRaw(keyData: Uint8Array, plaintext: Uint8Array, ad: Uint8Array | Uint8Array[]): Promise<Uint8Array> {
    // @ts-ignore
    const key = await miscreant.SIV.importKey(keyData, "AES-SIV");
    // @ts-ignore
  ...
  public async encryptKey(secret: string, users: User[], block: number, version: number) {
    ...
    const keysBase64 = f._arrayBufferToBase64(new TextEncoder().encode(JSON.stringify(body)).buffer as ArrayBuffer);
