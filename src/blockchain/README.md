...
Модуль для работы с блокчейном Pocketnet в проекте bastyon-vue. Предоставляет полную инфраструктуру для авторизации через приватные ключи, генерации адресов, подписи запросов и транзакций.
