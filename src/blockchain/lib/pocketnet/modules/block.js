...
import * as typeforce from './types.js';
...
export class Block {
  ...
  static calculateMerkleRoot(transactions, forWitness) {
    typeforce.typeforce([{ getHash: typeforce.types.Function }], transactions);
...
function txesHaveWitnessCommit(transactions) {
  return (
    ...
    transactions[0] &&
    transactions[0].ins &&
    Array.isArray(transactions[0].ins) &&
    transactions[0].ins[0] &&
    transactions[0].ins[0].witness &&
    Array.isArray(transactions[0].ins[0].witness) &&
