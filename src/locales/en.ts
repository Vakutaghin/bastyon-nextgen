...
export default {
  ...
  vault: {
    ...
    unlockPrompt: 'Enter your passphrase to unlock this wallet on this device.',
    ...
    resetConfirmYes: 'Clear and restore',
    cancel: 'Cancel',
    security: 'Wallet security',
    levelDevice: 'This device only',
    levelPassphrase: 'Passphrase protected',
    levelDegraded: 'No encryption at rest',
    levelDeviceDesc:
      'Your seed is encrypted with a key kept in this browser and never stored next to it. Set a passphrase for stronger protection against device backups.',
    levelPassphraseDesc:
      'Your seed is encrypted with your passphrase. It is required every time the app opens and is never stored.',
    levelDegradedDesc:
      'Secure storage is unavailable in this environment, so at-rest protection is limited. Use your recovery phrase as the source of truth.',
    enablePassphrase: 'Set a passphrase',
    disablePassphrase: 'Remove passphrase',
    setPassphrase: 'Choose a passphrase',
  ...
  header: {
    ...
    ipfsStatusError: 'Error: {message}',
    ipfsError: 'Error',
    ipfsInstallBtn: 'Install & start (~80 MB)',
    ipfsStartBtn: 'Start',
    ipfsStopBtn: 'Stop',
    ipfsUninstallBtn: 'Uninstall',
  ...
  messenger: {
    ...
    deleteConfirmText: 'The message will be removed for all chat participants.',
  ...
  auth: {
    ...
    copyKey: 'Copy private key',
    gotIt: 'Got it',
    seedCopied: 'Seed phrase copied. The clipboard will be cleared in a minute',
    keyCopied: 'Private key copied. The clipboard will be cleared in a minute',
    scanQr: 'Scan QR code',
    qrHide: 'Hide scanner',
    qrUpload: 'Upload image',
    qrUseCamera: 'Use camera',
    qrStopCamera: 'Stop camera',
    qrScanning: 'Point the camera at the QR code…',
    qrHint: 'Upload a QR-code image or scan one with the camera.',
    qrDecodeError: 'Could not read a QR code from the image.',
    qrCameraError: 'Failed to access the camera.',
    qrCameraUnavailable: 'Camera is not available on this device.',
  ...
  subscriptions: {
    ...
    unsubscribedToast: 'Unsubscribed',
  ...
  editProfile: {
    ...
    errAuthRequired: 'Sign in to edit your profile',
    errNameRequired: 'Name cannot be empty',
    errNoUnspents: 'No funds available for the transaction',
    errAvatarUpload: 'Failed to upload avatar',
    errFailed: 'Failed to update profile',
  },
  donate: {
    title: 'Tip the author',
    tip: 'Tip',
    to: 'To',
    amountPlaceholder: 'Amount in PKOIN',
    available: 'Available: {amount} PKOIN',
    send: 'Send tip',
    cancel: 'Cancel',
    sentToast: 'Tip sent',
    errAuthRequired: 'Sign in to send a tip',
    errNoRecipient: 'Recipient is not specified',
    errSelf: 'You cannot tip yourself',
    errAmount: 'Enter a valid amount',
    errAmountTooSmall: 'Amount is too small',
    errInsufficient: 'Insufficient funds',
    errFailed: 'Failed to send the tip',
  },
  report: {
    action: 'Report',
    ...
    intro:
      'Choose why you are reporting this content. The report is sent to the network for moderation.',
    reason1: 'Erotic / Porn',
    reason2: 'Child exploitation',
    reason3: 'Direct threat of violence',
    reason4: 'Illegal narcotics',
    reason6: 'Spam',
    submit: 'Submit report',
    cancel: 'Cancel',
    sentToast: 'Report submitted',
    authRequired: 'Sign in to report content',
  ...
  postCard: {
    ...
    deleteConfirmText: 'This removes the post from the network. It cannot be undone.',
    deleted: 'Post deleted',
    deleteFailed: 'Failed to delete the post',
    deleteAuthRequired: 'Sign in to delete the post',
  ...
  sidebar: {
    ...
    recommendedUsers: 'Who to follow',
    subscribersShort: '{n} followers',
    loading: 'Loading…',
    close: 'Close',
  ...
  miniapps: {
    ...
    allCategories: 'All',
    sideloadButton: 'Load local app',
    sideloadTitle: 'Load a local / dev mini-app',
    sideloadScopeLabel: 'App address (scope)',
    sideloadScopePlaceholder: 'localhost:3000 or https://dev.example.com/app',
    sideloadScopeHint: 'The host that serves the app’s b_manifest.json.',
    sideloadNameLabel: 'Display name (optional)',
    sideloadNamePlaceholder: 'Defaults to the manifest name',
    sideloadCancel: 'Cancel',
    sideloadLoad: 'Load',
    sideloadLoading: 'Loading…',
  ...
  limits: {
    ...
    ctaHeading: 'Limit reached',
    ctaBuy: 'Increase limits',
    ctaMessageBalance:
      'You have reached your limit for this action. Buy PKOIN to increase your limits.',
  ...
  notif: {
    ...
    browserNewCount: '{count} new notifications',
    filterSound: 'Sound',
    filterBrowser: 'Browser notifications',
  ...
  postMsg: {
    errAuthRequired: 'Authorization required to publish a post',
    errNoUnspents: 'No funds available for the transaction',
    errSelectUnspents: 'Failed to prepare funds for the transaction',
    ...
    validation: {
      ...
      videoCaption: 'Add a title for the video',
      urlSpam: 'Add more text to the link',
      scheduledInvalid: 'Invalid scheduled publish time',
      tags: 'Add at least one tag',
      tooManyTags: 'Too many tags (maximum 5)',
      tooManyImages: 'Too many images (maximum 10)',
      exchangeTag: 'The pkoin_commerce tag is incompatible with this content',
      pollTitle: 'Add a poll question',
      pollOptions: 'A poll needs at least 2 options',
      tooLarge: 'The post exceeds the allowed size',
    },
  },
  postComposer: {
    title: 'New post',
    ...
    tooManyImages: 'You can add up to {max} images',
    visibility: 'Visibility',
    visibilityAll: 'Everyone',
    visibilitySubscribers: 'Subscribers',
    visibilityRegistered: 'Registered',
    visibilityPaid: 'Paid subscribers',
    trialVisibilityHint: 'Trial accounts can only post for everyone',
    language: 'Language',
    editTitle: 'Edit post',
    repostTitle: 'Repost',
    save: 'Save',
    repostPublish: 'Repost',
    repostPlaceholder: 'Add a comment (optional)…',
    repostUnknownAuthor: 'Author',
    articleToggle: 'Article (rich editor)',
    articleTitlePlaceholder: 'Article title',
    articlePlaceholder: 'Start writing your article…',
    pollToggle: 'Poll',
  ...
  videoMsg: {
    ...
    loadTimeout: 'Video is taking too long to load',
    retry: 'Retry',
  },
  accountMsg: {
    ...
    seedCopied: 'Seed phrase copied. The clipboard will be cleared in a minute',
    privateKeyCopied: 'Private key copied. The clipboard will be cleared in a minute',
    ...
    nicknameReserved: 'A nickname cannot contain "bastyon" or "pocketnet"',
  ...
  update: {
    ...
    downloadHint:
      'The release page opens in your browser — installers for every platform are there.',
